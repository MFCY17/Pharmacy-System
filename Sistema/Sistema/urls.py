...
#Compra
from Farmacia.views import BuscarProveedor
...
from Farmacia.views import BuscarCliente
from Farmacia.views import cargarCliente
from Farmacia.views import AnularFactura
from Farmacia.views import reporte_ventas
...
from Farmacia.views import reporte_producto
...
urlpatterns = [
    ...
    url(r'^reset/password_reset$', password_reset,
        ...
        name='password_reset'),
    url(r'^reset/password_reset_done$', password_reset_done,{'template_name': 'Facturacion/Login/registration/password_reset_done.html'}, name='password_reset_done'),
    url(r'^reset/(?P<uidb64>[0-9A-Za-z_\-]+)/(?P<token>.+)/$', password_reset_confirm,{'template_name': 'Facturacion/Login/registration/password_reset_confirm.html'}, name= 'password_reset_confirm'),
    url(r'^reset/done',password_reset_complete,{'template_name': 'Facturacion/Login/registration/password_reset_complete.html'}, name='password_reset_complete'),
    ...
    url(r'^eliminar_presentaciones/(?P<id_presentacion>\d+)/$', views.eliminar_presentaciones, name='eliminarpresentaciones'),
    #Usuario

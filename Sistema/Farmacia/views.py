...
from .forms import CompraForm, CompraPagosFormSet, CompraPagosEditFormSet, PagoForm, DetalleCompraForm
...
class ReporteProveedores(View):  
    ...
    def tabla(self,pdf,y):
        ...
        detalle_ordenpro = Table([encabezadospro] + detallespro, colWidths=[3 * cm, 3 * cm, 2.5 * cm, 8 * cm,  3.5 * cm,])
